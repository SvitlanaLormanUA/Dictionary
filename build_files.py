...
def process_file(file_name, dictionary, incidence_matrix, inverted_index, positional_index, biword_index):
    try:
...
def build_index():
    ...
    for file in files:
        process_file(file, dictionary, incidence_matrix, inverted_index, positional_index, biword_index)
